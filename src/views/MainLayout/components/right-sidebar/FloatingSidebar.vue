<template>
    ...
    <el-popover placement="left" title="" :width="300" trigger="hover" :visible="sponsorHintVisible" content="为了甲方爸爸继续支持我们，各位爹注册一下吧🙏，凑凑人头吧，祝你们长生不老永远不死。🙇">
        <template #reference>
            <el-button class="sponsor-button" plain @mouseenter="sponsorHintVisible = true" @mouseleave="sponsorHintVisible = false" @click="adImageDialogVisible = true">金主要求注册150人</el-button>
        </template>
    </el-popover>
        ...
        <el-popover :visible="popoverVisible" placement="top" title="甲方要求150人注册。ありがとう米娜桑" :width="310">
            <template #reference>
                <div class="layout-ad-content">
                    ...
                    <el-button class="ad-close-button" :icon="Close" circle size="small" @click.stop.prevent="closeLayoutAd" />
                </div>
            </template>
...
<script setup lang="ts">
    ...
    const adImage = computed(() => {
        return isHomeRoute.value ? 'https://pic1.imgdb.cn/item/6a05712957da1d412e138abd.jpg' : 'https://pic1.imgdb.cn/item/6a05712a57da1d412e138abe.png';
    });
